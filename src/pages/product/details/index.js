...
const PumpDetails = () => {
    ...
    if (!isLoaded) {
        ...
        return (
            <div className="bg-white h-screen max-w-7xl lg:px-0 px-8 mx-auto">
                <Navbar />
                <div className="grid grid-cols-2 gap-5 mt-40 mb-20">
                ...
                <div className="grid grid-cols-4 gap-3 px-8 mt-5">
                    {cardData?.map((item, index) => {
                        if (item?.image) {
                            return (
                                <div key={index} className="border-2 border-solid lg:col-span-1 md:col-span-2 col-span-4 border-blue-400 p-8 rounded-lg shadow-xl">
